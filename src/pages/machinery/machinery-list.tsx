...
const MachineryTablesPage = () => {
  ...
  const [filters] = useState([
    ...
    { label: 'MaintenanceSchedule', title: 'maintenance_schedule' },

    { label: 'LastMaintenanceDate', title: 'last_maintenance', date: 'true' },
  ]);
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <Link href={'/machinery/machinery-table'}>Switch to Table</Link>
          </div>
        </CardBox>
