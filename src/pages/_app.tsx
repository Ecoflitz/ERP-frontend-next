...
function MyApp({ Component, pageProps }: AppPropsWithLayout) {
  ...
  const description = 'ERP generated by ecoflitz';

  const url = 'https://ecoflitz.co.uk';

  const image = `https://ecoflitz.com/logo.svg`;
      ...
      {getLayout(
        <>
          <Head>
            ...
            <meta property='og:site_name' content='https://ecoflitz.co.uk/' />
